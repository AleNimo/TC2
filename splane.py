...
def dibujar_funcion_exc_abajo(d, func_label, sym_func, k_gap_width=0.5, hacia_salida  = False):
...
def remover_polo_dc( imit, omega_zero = None):
    ...
    k_cero * s : Symbolic
        Imitancia restada
    1/k_cero : Symbolic
        Valor del componente removido (tanto inductor como capacitor si es admitancia o impedancia respectivamente)
    '''
    ...
    return( [imit_r, k_cero*s, 1/k_cero] )
...
def remover_polo_infinito( imit, omega_zero = None ):
    ...
    k_inf * s : Symbolic
        Imitancia restada
    k_inf : Symbolic
        Valor del componente removido (tanto capacitor como inductor si es admitancia o impedancia respectivamente)
    '''
    ...
    return( [imit_r, k_inf*s, k_inf] )

def remover_valor( imit, sigma_zero, isImpedance = True):
    '''
...
def remover_valor_en_infinito( imit, isImpedance = True):
    '''
...
def remover_valor_en_dc( imit, isImpedance = True):
    '''
